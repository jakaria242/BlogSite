...
const Navbar = () => {
  return (
    <nav className='w-full	py-6 bg-[#0d0d29]'>
      <Div className="container mx-[auto] grid grid-cols-3	items-center">

        <Div className="text-5xl italic	font-extrabold	text-white"> MyBlog </Div>
         <Div>
        ...
        {/*=================== Mega menu star ===================*/}
              ...
              <li className='group'>
                ...
                <Div className='absolute z-10	bg-[#fff]  max-w-[1170px] w-[100%] py-[20px] px-[30px] transition-all duration-500 mt-[40px] ease-in-out	group-hover:mt-[5px] opacity-0 invisible group-hover:visible group-hover:opacity-100 left-[50%]	translate-x-leftMiddle flex flex-wrap	 justify-between flex-flexGap'>
                    <Div>
                    ...
                    <Div className='w-[250px] h-[300px] align-middle'>
        ...
        {/*=================== Mega menu star ===================*/}
          ...
          <Div className='absolute z-10	bg-[#fff]  max-w-[1170px] w-[100%] pt-[30px] pb-[45px] px-[20px] transition-all duration-500 mt-[40px] ease-in-out	group-hover:mt-[5px] opacity-0 invisible group-hover:visible group-hover:opacity-100 left-[50%]	translate-x-leftMiddle flex justify-around  gap-[20px]'>
               <Div className='w-[250px] h-[270px] text-center'>
                    <Image className="h-[100%] w-[100%] object-cover" source={category1} alt="not found"/>
                    <h3 className='text-medium text-[16px] text-[red]  mt-[10px]'>News</h3>
                </Div>
                <Div className='w-[250px] h-[270px] text-center'>
                    <Image className="h-[100%] w-[100%] object-cover" source={category2} alt="not found"/>
                     <h3 className='text-medium text-[16px] text-[red]  mt-[10px]'>Blog</h3>
                </Div>
                <Div className='w-[250px] h-[270px] text-center'>
        ...
        {/*=================== Dropdown menu star ===================*/}
              ...
              <Div className='absolute z-10	bg-[white] min-w-[280px] max-w-[350px] py-[20px] px-[30px] transition-all duration-500 mt-[40px] ease-in-out	group-hover:mt-[5px] opacity-0 invisible group-hover:visible group-hover:opacity-100'>
                <Ul>
        ...
        {/*=================== Dropdown menu star===================*/}
          ...
          <li className='group'>
            <NavLink to="/contract" className="relative after:absolute after:content-[''] after:w-0 after:h-1  after:bottom-[-5px] after:left-0 hover:after:w-full after:transition-all after:duration-300 after:bg-indigo-300 duration-300 hover:text-[orange]">contract</NavLink>
              ...
              <Div className='absolute z-10	bg-[white] min-w-[250px] max-w-[350px] py-[20px] px-[30px] transition-all duration-500 mt-[40px] ease-in-out	group-hover:mt-[5px] opacity-0 invisible group-hover:visible group-hover:opacity-100 left-[65%]	translate-x-leftMiddle'>
