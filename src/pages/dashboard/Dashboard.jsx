  ...
  return (
    ...
    <Div className="py-10">
                <Div className="flex flex-wrap justify-start items-center lg:justify-center gap-2 lg:gap-10 px-4 lg:px-0 mb-8">
                    ...
                    <Div className="right">
                        <Heading level="2" className='font-bold text-2xl mb-2 text-[black] capitalize'>Jakaria islam</Heading>
                        ...
                        <Div className=" flex gap-2 mt-2">
                            ...
                            <Div className="mb-2">
                            <Button className='px-8 py-2 rounded-2xl bg-[rgb(30,41,59)] text-white' text="Logout"/>
                            </Div>
                        </Div>
                    </Div>
                </Div>
